 ...
 * 9/11/17
 * 
 * TLG.Concordance has been modified to time how long it takes Analyzer.cs to run.
 * Analyzer.cs code may be commented and uncommented between char[] and string
 * 
 */ 
